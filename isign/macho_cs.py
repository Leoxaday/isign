...
CodeDirectory = Struct("CodeDirectory",
                       ...
                       Pointer(lambda ctx: ctx['cd_start'] - 8 + ctx['identOffset'], CString('teamID')),
                       If(lambda ctx: ctx['version'] >= 0x20200, Pointer(lambda ctx: ctx['cd_start'] - 8 + ctx['teamIDOffset'], CString('ident'))),
